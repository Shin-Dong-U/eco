...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        ...
                                        <div>
                                        	...
                                        	<select name="option" class="orderOption" id="option-select">
                                        ...
                                        <div class="action">
                                            <a class="btn" class="addCartBtn" ><i class="fa fa-shopping-cart"></i>카트에담기</a>
                                            <button class="addCartBtn" >카트에담기</button>
                                            <a class="btn" class="buyNowBtn"><i class="fa fa-shopping-bag"></i>바로주문</a>
        ...
        <script src="${contextPath}/resources/basket/basket.js?ver=7"></script>
    ...
    console.log("orderinfo :"+orderinfo.toString());
	console.log("orderinfo :"+orderinfo.cust_id,orderinfo.qty,orderinfo.orderOption,orderinfo.goods_seq);
  //상품카트에 담기
	$('.addCartBtn').on('click',function(orderinfo){
		orderinfo={
	    		cust_id:'ordercheck',
	    		qty:$(".orderQty").val(),
	    		orderOption:$(".orderOption").val(),
