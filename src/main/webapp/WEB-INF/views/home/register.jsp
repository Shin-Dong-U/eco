...
<html lang="kr">
    ...
    <body>
        ...
        <!-- Login Start -->
	<form id="registerForm" action="/registerCust" method="post">
        <div class="login">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">    
                        <div class="register-form">
                            ...
                            <!-- Company_yn radiobutton으로 체크하기 -->
                                ...
                                <div class="col-md-6">
                                    <label>ADDR</label>
                                    <input class="form-control" type="text" placeholder="ADDR">
                                </div>
                                
                                <div class="col-md-6">
                                    <label>Birth</label>
                                    <input class="form-control" type="date" name="birth" placeholder="Birth">
                                   <!--  /*달력으로 변경*/ -->
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table style="width:100%; text-align:center;">
										...
										<tr>
											<td><input class="form-control companyCheck" id="male" type="radio" name="sex_check" value="1" checked/></td>
											<td><input class="form-control companyCheck" id="female" type="radio" name="sex_check" value="2"/> </td>
										</tr>  
									</table>                             
                                </div>
